...
**Related:** [linked-list (data-structures)](../data-structures/linked-list.md) · [Linked List lesson](../learning/07-linked-list.md) · [Two Pointers lesson](../learning/02-two-pointers.md)
