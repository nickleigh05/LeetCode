...
[← Prev](00g-pattern-recognition.md) · [🗺 Roadmap](../../roadmap.md) · [Next →](01b-prefix-sums.md)
...
For the full string method reference (split, strip, replace, f-strings, `Counter`), see the [syntax cookbook](../syntax/_index.md#variables--basic-types). Everything else about strings *is* the array material above.
