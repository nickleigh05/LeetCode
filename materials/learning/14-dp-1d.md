...
> **Builds on:** [recursion (04b)](05-recursion.md) — specifically the recursion-tree and memoization ideas. DP is recursion that remembers its answers instead of recomputing them.
...
Work the guided set with hints & solutions: [**1-D Dynamic Programming — Practice →**](../rmap-practice/14-dp-1d.md). Easy → hard, top to bottom; when the pattern feels automatic, move on — don’t grind it forever. Want more volume? See the [recommended list](../../lists/recommended.md#13-1-d-dynamic-programming-22-problems).
