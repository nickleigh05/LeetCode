...
> **Builds on:** [recursion (04b)](04b-recursion.md) — specifically the recursion-tree and memoization ideas. DP is recursion that remembers its answers instead of recomputing them.
...
Work the guided set with hints & solutions: [**1-D Dynamic Programming — Practice →**](../rmap-practice/13-dp-1d.md). Easy → hard, top to bottom; when the pattern feels automatic, move on — don’t grind it forever. Want more volume? See the [recommended list](../../lists/recommended.md#13-1-d-dynamic-programming-22-problems).

## Check Yourself

- [ ] For a new problem I can name the *state*, write the *transition*, and state the *base case* out loud.
- [ ] I can convert a top-down memoized solution into a bottom-up table, then into O(1) rolling variables.
- [ ] I recognize the families (linear, Kadane, knapsack, unbounded, LIS) by their recurrence.
- [ ] I solved a 🔴 Hard 1-D DP problem (e.g. Word Break or Longest Increasing Subsequence in n log n).
