...
|-------|-------------------|---------------------------|
| n ≤ 12 | O(n!) | Permutation [backtracking](../learning/11-backtracking.md) |
...
| n ≤ 100,000 | O(n log n) | [Sort](../learning/06b-sorting.md), [heap](../learning/10-heap-priority-queue.md), [binary search](../learning/06-binary-search.md), [segment tree](../learning/20-segment-trees.md) |
...
| n ≤ 10⁹ or 10¹⁸ | O(log n) or O(1) | You never iterate n — [binary search on the answer](../learning/06-binary-search.md), math/[digit tricks](../learning/19-bit-manipulation.md), [fast exponentiation](../algorithms/fast-exponentiation.md) |
...
- **Grid up to 300 × 300** → n is really 9·10⁴ cells → O(cells) or O(cells · log) [BFS/DFS](../learning/12-graphs.md); O(cells²) is dead.
