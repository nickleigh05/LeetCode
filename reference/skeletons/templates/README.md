...
*Categories follow the NeetCode 150/250 taxonomy. For the curated problem sets that pair with these skeletons, see [../lists/](../lists/); for deeper conceptual notes, see [../reference/](../reference/).*
